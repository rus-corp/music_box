...
from sqlalchemy import Table, Column, Integer, DateTime, String, ForeignKey, Boolean
...
group_track_clollection_association = Table(
  'group_track_clollection_association',
  Base.metadata,
...
class TrackCollection(Base):
  ...
  group_collections: Mapped[List['CollectionGroup']] = relationship(secondary=group_track_clollection_association, back_populates='track_collections')
...
class CollectionGroup(Base):
  ...
  track_collections: Mapped[List['TrackCollection']] = relationship(secondary=group_track_clollection_association, back_populates='group_collections')
